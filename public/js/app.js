...
(function () {
	...
	var _user$project$Main$bookView = function _user$project$Main$bookView(book) {
		return A2(_elm_lang$html$Html$ul, { ctor: '[]' }, {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(_elm_lang$html$Html$li, { ctor: '[]' }, {
						ctor: '::',
						_0: _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(book.published)),
						_1: { ctor: '[]' }
					}),
					_1: { ctor: '[]' }
				}
	...
	var _user$project$Main$Book = F3(function (a, b, c) {
		return { title: a, author: b, published: c };
	});
	var _user$project$Main$bookDecoder = A4(_elm_lang$core$Json_Decode$map3, _user$project$Main$Book, A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'title',
		_1: { ctor: '[]' }
	...
	var _user$project$Main$decodeBooks = A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'result',
		_1: { ctor: '[]' }
	}, _elm_lang$core$Json_Decode$list(_user$project$Main$bookDecoder));
	var _user$project$Main$Model = function _user$project$Main$Model(a) {
		return { books: a };
	};
	var _user$project$Main$init = {
		ctor: '_Tuple2',
		_0: _user$project$Main$Model({ ctor: '[]' }),
		_1: _elm_lang$core$Platform_Cmd$none
	};
	var _user$project$Main$RequestBooks = { ctor: 'RequestBooks' };
	var _user$project$Main$view = function _user$project$Main$view(model) {
		return A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
			ctor: '::',
			_0: A2(_elm_lang$html$Html$div, { ctor: '[]' }, A2(_elm_lang$core$List$map, _user$project$Main$bookView, model.books)),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html$button, {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RequestBooks),
					_1: { ctor: '[]' }
				}, {
					ctor: '::',
					_0: _elm_lang$html$Html$text('Get Books!'),
					_1: { ctor: '[]' }
				}),
				_1: { ctor: '[]' }
			}
	...
	var _user$project$Main$GetBooks = function _user$project$Main$GetBooks(a) {
		return { ctor: 'GetBooks', _0: a };
	};
	var _user$project$Main$getBooks = function () {
		var url = 'http://localhost:8000/api/v1/books';
		var req = A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeBooks);
		return A2(_elm_lang$http$Http$send, _user$project$Main$GetBooks, req);
	}();
	var _user$project$Main$update = F2(function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'GetBooks') {
			if (_p0._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(model, { books: _p0._0._0 }),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, _elm_lang$core$Basics$toString(_p0._0._0), model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
		} else {
			return { ctor: '_Tuple2', _0: model, _1: _user$project$Main$getBooks };
		}
	});
	var _user$project$Main$main = _elm_lang$html$Html$program({ init: _user$project$Main$init, update: _user$project$Main$update, view: _user$project$Main$view, subscriptions: _user$project$Main$subscriptions })();
